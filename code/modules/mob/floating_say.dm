...
// This code was written by Chinsky for Nebula, I just made it compatible with Eris. - Matt. Made it compatible with Hestia(bay) -> Foxterosa. Ported to Vesta - Foxterosa
