...
#define UNRESTRICTED_SPECIES list(SPECIES_HUMAN,SPECIES_PROMETHEAN, SPECIES_DIONA, SPECIES_IPC, SPECIES_UNATHI, SPECIES_SKRELL, ,SPECIES_AKULA, SPECIES_TRITONIAN, SPECIES_SPACER, SPECIES_VATGROWN, SPECIES_SERGAL, SPECIES_VULP, SPECIES_GRAVWORLDER, SPECIES_BOOSTER, SPECIES_MULE, SPECIES_CUSTOM, SPECIES_ADHERENT)
